...
Please visit my github repository to access all documentation related to this project! https://github.com/hantimps/time_use_project  
...
More detailed explanations of the variables used and data origins can be accessed in the codebook here: https://github.com/hantimps/time_use_project/blob/main/data/codebook.txt 
